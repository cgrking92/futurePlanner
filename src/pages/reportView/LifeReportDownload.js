...
import ObjectBooks from 'components/books/RelationshipBooks';
            ...
            <div className="container">
                <div className="contents _03_03">
                    <div className="print_wrap">
                        ...
                        <b>{childName}</b> 어린이는<span>{transInterResult1}</span>, <span>{transInterResult2}</span> 에 가장 관심도가 높고 <span>{transPerResult}</span> 영역 발달에 더 많은
                            관심을 가져야 될 것으로 보입니다.
                            <br/><br/>
                            <b>{childName}</b> 어린이의 높은 생활 관심도는 <span>{transInterResult1}</span> ,<span>{transInterResult2}</span>이고, 이러한 프로파일은 잉글리시에그 콘텐츠와 <span>{totalScore}%</span>일치하는 것으로
                            나타났습니다.
                        </div>
...
export default LifeReportDownload;