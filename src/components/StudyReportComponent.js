...
const StudyReportComponent = (props) => {
    ...
    return (
        ...
        <div className="print_wrap">
            ...
            <div className="text_box">
                <b>{cookies.childName}</b>어린이의 습득 성향은 <b>'{rankResult} Learner'</b> 입니다.
            </div>
            ...
            <div className="report_text clera">                
                ...
                <p className="t1">{cookies.childName} 어린이는 Visual Learner로 시각적 자극을 통한 정보 습득력이 좋은 아이 입니다.</p>
                <p>
                ...
                <p>
                    잉글리시에그의 다양한 화풍과 Picture Walk에 적합한 삽화는 Visual Learner인 {cookies.childName} 어린이에게 적합한 습득 도구입니다.
                    책을 읽을 때 그림책 표지에 관한 이야기를 나누면서 호기심을 자극해 주세요.
                    Picture Walk를 통해 그림이 주는 힌트를 충분히 이해하고 전체 이야기를 추측하는 활동은 {cookies.childName} 어린이의 스토리텔링 참여를 더욱더 즐겁게 해 줍니다. 
                    서정적이고 감성적인 삽화의 잉글리시에그 그림책과 영상을 통한 다양한 시각적 노출은 Visual Learner인 {cookies.childName} 어린이의 몰입도를 높여 영어 습득을 돕게 됩니다.
                </p>
            </div>
            }{rankResult === 'Kinesthetic' &&
            <div className="report_text clera">                
                <img src="/assets/img/future/04_05.png" alt=""/>
                <p className="t1">{cookies.childName} 어린이는 Kinesthetic Learner로  신체적 활동을 통해 새로운 것을 배우는 것이 익숙한 아이입니다.</p>
                <p>
                ...
                <p>
                    교구와 T.P.R.을 활용한 잉글리시에그의 영어 놀이는 Kinesthetic Learner인 {cookies.childName} 어린이에게 적합한 학습 방법입니다. 
                    에그의 놀이자료를 책과 연계해 활용해 주시고 댄스 영상을 보며 손동작과 춤을 따라 할 수 있게 해주세요. 
                    책, 플링, CD, Song Card 등을 활용해 같은 콘텐츠를 지루하지 않게 반복해 주는 것이 좋습니다. 
                    에그 콘텐츠의 일상대화로 재연해 보는 역할극 놀이는 {cookies.childName} 어린이의 운동 감각적 영어 습득을 돕게 됩니다.
                </p>                
            </div>
            }{rankResult === 'Auditory' &&
            <div className="report_text clera">                
                <img src="/assets/img/future/04_04.png" alt=""/>
                <p className="t1">{cookies.childName} 어린이는 Auditory Learner로 청각적인 자극을 통한 정보 습득력이 좋은 아이입니다.</p>
                <p>
                ...
                <p>
                    잉글리시에그의 고퀄리티 오디오는 Auditory Learner인 {cookies.childName} 어린이에게 적합한 학습 도구입니다. 
                    에그의 음악들을 일상생활의 배경음악으로 활용해 주시고 눈으로 읽기 전에 플링펜으로 책 내용을 들을 수 있게 해주세요. 
                    하나의 텍스트를 노래와 내레이션으로 다양하게 접근하는 것이 좋습니다. 
                    브로드웨이 뮤지컬 배우들이 녹음한 잉글리시에그 오디오는 영어 특유의 라임, 악센트, 표현력을 살리고 있어 {cookies.childName} 어린이의 청각적 영어 습득을 돕게 됩니다.
                </p>                
            </div>
            }
...
export default StudyReportComponent;
